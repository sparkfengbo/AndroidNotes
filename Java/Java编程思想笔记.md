...
- 可以在方法里面或者任意作用域内定义内部类
- 匿名内部类相当于创建一个继承自xxx的匿名类的对象
- 普通内部类不能包含static数据和字段，也不能包含嵌套类，但是嵌套类可以包含这些关系

**非静态的内部类和匿名内部类都会隐式地持有其外部类的引用**

`.new`语法如下：

![](https://github.com/sparkfengbo/AndroidNotes/blob/master/PictureRes/JavaBCXS/%E5%86%85%E9%83%A8%E7%B1%BB1.png?raw=true)


内部类举例：

![](https://github.com/sparkfengbo/AndroidNotes/blob/master/PictureRes/JavaBCXS/%E5%86%85%E9%83%A8%E7%B1%BB2.png?raw=true)

![](https://github.com/sparkfengbo/AndroidNotes/blob/master/PictureRes/JavaBCXS/%E5%86%85%E9%83%A8%E7%B1%BB5-1.png?raw=true)
![](https://github.com/sparkfengbo/AndroidNotes/blob/master/PictureRes/JavaBCXS/%E5%86%85%E9%83%A8%E7%B1%BB5-2.png?raw=true)

![](https://github.com/sparkfengbo/AndroidNotes/blob/master/PictureRes/JavaBCXS/%E5%86%85%E9%83%A8%E7%B1%BB5-4.png?raw=true)

![](https://github.com/sparkfengbo/AndroidNotes/blob/master/PictureRes/JavaBCXS/%E5%86%85%E9%83%A8%E7%B1%BB5-5.png?raw=true)

![](https://github.com/sparkfengbo/AndroidNotes/blob/master/PictureRes/JavaBCXS/%E5%86%85%E9%83%A8%E7%B1%BB5-6.png?raw=true)

![](https://github.com/sparkfengbo/AndroidNotes/blob/master/PictureRes/JavaBCXS/%E5%86%85%E9%83%A8%E7%B1%BB5-7.png?raw=true)

## 12 Exception

1.可以在catch中重新将异常抛出，那么在上一层捕获的异常的printStackTrace信息还是原来抛出点的异常信息，如果想更新这个信息，重新抛出新的异常（new）或者调用fillInStackTrace方法

2.异常链  通过`initCause`方法添加引起异常的原因
...
![](https://github.com/sparkfengbo/AndroidNotes/blob/master/PictureRes/JavaBCXS/C13String1.png?raw=true)
![](https://github.com/sparkfengbo/AndroidNotes/blob/master/PictureRes/JavaBCXS/C13String2.png?raw=true)
![](https://github.com/sparkfengbo/AndroidNotes/blob/master/PictureRes/JavaBCXS/C13String3.png?raw=true)
![](https://github.com/sparkfengbo/AndroidNotes/blob/master/PictureRes/JavaBCXS/C13String4.png?raw=true)
...
![](https://github.com/sparkfengbo/AndroidNotes/blob/master/PictureRes/JavaBCXS/annotation1.png?raw=true)
![](https://github.com/sparkfengbo/AndroidNotes/blob/master/PictureRes/JavaBCXS/annotation2.png?raw=true)
#### 1.2 定义注解元注解
##### 1.2.1.@Target
...
但是这并不是真的继承。通过使用@Inherited，只可以让子类类对象使用getAnnotations（）反射获取父类被`@Inherited`修饰的注解。
...
![](https://github.com/sparkfengbo/AndroidNotes/blob/master/PictureRes/JavaBCXS/annotation3.png?raw=true)
