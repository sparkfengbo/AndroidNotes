...
function adOptReport(e,a,p,i){
Report("http://mp.weixin.qq.com/mp/ad_complaint?&action=report&type="+e+"&pos_type="+a+"&trace_id="+p+"&aid="+i+"&__biz="+window.biz+"&r="+Math.random());
}
...
m=u.use_new_protocol)4==u.pos_type?(d=!0,u=p(u),f=u):0==u.pos_type?(u=i(u),(12==u.product_type||19==u.product_type)&&(f=u)):3==u.pos_type&&(u=t(u),
f=u);else if(100==u.pt||115==u.pt){
for(var g=u.exp_info.exp_value||[],y=!1,h=0,v=0;v<g.length;++v){
var w=g[v]||{};
if(1==w.exp_type&&(h=w.comm_attention_num,y=h>0),2==w.exp_type){
y=!1,h=0;
break;
}
}
u.biz_info.show_comm_attention_num=y,u.biz_info.comm_attention_num=h,f={
...
var E=u.card_info.card_id||"",O=u.card_info.card_ext||"";
O=O.htmlDecode();
try{
O=JSON.parse(O),O.outer_str=u.card_info.card_outer_id||"",O=JSON.stringify(O);
}catch(C){
O="{}";
}
f={
...
var z=u.mp_shop_info.pid||"",B=u.mp_shop_info.outer_id||"";
f={
pid:z,
outer_id:B,
pt:u.pt,
...
u.image_url=ParseJs.addParam(A,"wxfrom","50",!0)),adDatas.ads["pos_"+u.pos_type]={
a_info:u,
adData:f
...
for(var R in S)if(0==R.indexOf("pos_")){
var f=S[R],u=!!f&&f.a_info;
if(f&&u){
if(console.log(u),0==u.pos_type){
if(u.new_appmsg=window.new_appmsg,js_bottom_ad_area.innerHTML=TMPL.tmpl(a_tpl,u),
111==u.pt||112==u.pt||113==u.pt||114==u.pt){
var N=document.getElementsByClassName("js_download_app_card")[0],H=N.offsetWidth,U=Math.floor(H/2.875);
...
var P=js_sponsor_ad_area.clientWidth;
108==u.pt||109==u.pt||110==u.pt?document.getElementById("js_main_img").style.height=P/1.77+"px":116==u.pt||117==u.pt,
DomEvent.on(window,"scroll",T),T(0);
}else 4==u.pos_type&&(console.log("test"),_checkShowCpc()&&(u=_parseExpCpc(u),console.log(u),
js_cpc_area.innerHTML=TMPL.tmpl(cpc_a_tpl,u),console.log("show cpc")));
lazyLoadAdImg({
aid:u.aid,
type:u.pt
...
if(has_click[t]=!1,v&&(v.style.display="none"),g.canvas_info)return console.log(" jsapi invoke OpenADCanvas"),
...
var i=p.getElementsByClassName("js_ad_link")||[],t=adDatas.ads[a],o=p.getElementsByClassName("js_ad_opt_list_btn_"+e),n=p.getElementsByClassName("js_complain_btn_"+e);
if(console.log("optListBtns",o),console.log("complainBtns",n),t){
for(var _=t.adData,r=t.a_info,d=r.pos_type,s=t.ad_engine,c=0,l=i.length;l>c;++c)!function(e,a){
var p=i[e],t=p.dataset;
if(t&&3!=r.pos_type){
var _=t.type,c=t.url,l=t.rl,m=t.apurl,f=t.tid,u=t.ticket,g=t.group_id,y=t.aid,h=t.pt,v=r.use_new_protocol,w=!0;
console.log("js click data: ",t),console.log("js click data: ",r),(v&&(12==r.product_type||19==r.product_type)||115==h)&&(w=!1,
console.log("js dom event type: ",w)),4==r.pos_type&&(w=!1,console.log("js dom for pos_type:4 event type: ",w)),
DomEvent.on(p,"click",function(e){
var p=!!e&&e.target;
if(p&&"js_ad_btn"==p.id);else if(!p||!p.className||-1==p.className.indexOf("js_ad_btn")&&-1==p.className.indexOf("js_btn_process")&&-1==p.className.indexOf("js_muted_btn")&&-1==p.className.indexOf("js_poster_cover")&&-1==p.className.indexOf("js_ad_opt_list_btn")&&-1==p.className.indexOf("js_complain_btn")){
if(a){
...
var t,o,n,w;
return t=position.getX(p,"js_ad_link")+e.offsetX,o=position.getY(p,"js_ad_link")+e.offsetY,
...
ad_click(_,c,l,m,f,u,g,y,h,d,s,a,t,o,n,w,r,i,v),log("[Ad] ad_click: type="+_+", url="+c+", rl="+l+", apurl="+m+", traceid="+f+", ticket="+u+", group_id="+g+", aid="+y+", pt="+h+", pos_type="+d+", ad_engine="+s),
!1;
}
},w),DomEvent.on(p,"touchstart",function(){
...
var h=require("a/app_card.js"),v=15,w=_.pkgname&&_.pkgname.replace(/\./g,"_"),x=document.getElementById("js_ad_btn_"+d);
new h({
btn:x,
adData:_,
report_param:y,
...
via:[_.traceid,_.adid,w,source,v,s].join("."),
ticket:_.ticket,
appdetail_params:["&aid="+_.adid,"traceid="+_.traceid,"pkgname="+w,"source="+source,"type="+v,"engine="+s,"appuin="+biz,"pos_type="+d,"ticket="+_.ticket,"scene="+scene].join("&"),
engine:s
});
}
if(9==r.material_type){
r.report_param=y;
var j=require("a/video.js");
console.log("video_info",r),new j(r),console.log("new video loaded");
}
}else{
if("100"==_.pt||"115"==_.pt){
var k=require("a/profile.js");
return void new k({
...
if("102"==_.pt){
var b=require("a/android.js"),v=15,w=_.pkgname&&_.pkgname.replace(/\./g,"_");
return void new b({
btn:document.getElementById("js_app_action_"+d),
adData:_,
report_param:y,
task_ext_info:[_.adid,_.traceid,w,source,v,s].join("."),
via:[_.traceid,_.adid,w,source,v,s].join(".")
});
}
if("101"==_.pt){
...
var h=require("a/app_card.js"),v=15,w=_.pkgname&&_.pkgname.replace(/\./g,"_");
return void new h({
...
console.log("can_see_complaint",can_see_complaint);
