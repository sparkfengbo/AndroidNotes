...
function a(e){
var a=e.adData,d=e.pos_type,s=a.traceid,m=e.a_info.type,y=a.adid,v=a.url,g=e.a_info.rl;
110==a.pt&&(v=v.replace("#","&AdType=80#"));
var h={};
e.report_param=e.report_param||"";
var b=e.adDetailBtn,j=e.adMoreBtn,x=(e.adMessage,e.adAbout),z=e.adComplain,k=e.adImg,T=e.adVideo,W=0,I=document.getElementById("js_sponsor_opt_list"),H={
type:m,
report_type:2,
url:encodeURIComponent(v),
tid:s,
rl:encodeURIComponent(g),
__biz:biz,
pos_type:d,
pt:a.pt,
click_pos:""
...
if(g){
g=g.split("?"),g=g.length>1?g[1]:"";
var A=new RegExp("(^|&)viewid=([^&]*)(&|$)","i"),U=g.match(A);
U&&(E=unescape(U[2]));
}
window.__video_report_data={
aid:a.adid,
...
var M=null,S=!0,q=!1;
if(p.isAndroid&&p.gtVersion("6.6.6",!0)&&(q=!0),T&&a.videoUrl){
O=new l({
container:T,
cover:a.thumbUrl,
width:T.offsetWidth,
height:T.offsetWidth*parseInt(a.displayHeight)/parseInt(a.displayWidth),
muted:!0,
ad_muted_btn:!0,
always_hide_loading:!0,
src:a.videoUrl,
...
blockTouchVideo:!0,
onError:function(t){
console.log("播放出错",t),i(123,e),T.parentNode.innerHTML='<span class="ct_mpda_main_img img_bg_cover" id="js_main_img" style="background-image:url('+a.thumbUrl+"); height:"+f.clientWidth/1.77+'px;"></span>',
window.__video_report_data.play_type=3;
},
onEnd:function(){
...
window.__video_report_data.report_type=2,O.play(),o();
},
...
window.__video_report_data.video_duration=1e3*O.__getDuration(),w||(window.__video_report_data.report_type=3,
o(),w=1);
}
}),W=29,O._showPlayer(),O.setSrc(a.videoUrl,"auto");
var P=window.pageYOffset||document.documentElement.scrollTop||document.body.scrollTop,C=document.documentElement.clientHeight||window.innerHeight;
if(p.isAndroid)if(f.offsetTop>P&&f.offsetTop<P+C)window.__video_report_data.auto_play=0;else{
var B=function(){
O.__beginPlayHandler(),r.off(window,"touchstart",B),q=!0;
};
r.on(window,"touchstart",B);
}
var D=function(){
if(3==window.__video_report_data.play_type)return void r.off(window,"scroll",D);
...
C=document.documentElement.clientHeight||window.innerHeight,O.isPlay()&&(f.offsetTop>P+C||f.offsetTop+f.offsetHeight<P))O.pause();else if(!O.isPlay()&&!(f.offsetTop>P+C||f.offsetTop+f.offsetHeight<P)){
if(p.isAndroid&&!q)return;
0==window.__video_report_data.play_type&&1==window.__video_report_data.auto_play?(i(121,e),
p.isIOS&&O.triggerMuted(!0),O.__beginPlayHandler()):O.play();
}
};
r.on(window,"scroll",D),D(),M=function(){
window.setTimeout(function(){
O.triggerMuted(!0);
},1e3);
};
...
console.log(e.target),e.target==x||e.target==b||e.target==z||e.target.className.indexOf("js_opt_item")>=0||(x.style.display="none",
z.style.display="none",I.style.display="none");
}),r.on(document.getElementById("js_ad_inner"),"click",function(t){
if(t.target.className.indexOf("js_muted_btn")>-1)"true"==O.video.getAttribute("muted")?(O.triggerMuted(!1),
S=!1):(O.triggerMuted(!0),S=!0),i(124,e);else{
if(O&&(!O.isPlay()||0==window.__video_report_data.play_type))return O.__beginPlayHandler(),
S||O.triggerMuted(!1),i(121,e),void(window.__video_report_data.play_type=2);
"js_main_img"==t.target.id||t.target.className.indexOf("video_mask")>-1?h[s+"_1"]||(h[s+"_1"]=!0,
H.click_pos=1,u(H,function(){
i(87+W,e),h[s+"_1"]=!1,!!M&&M(),6!=e.a_info.dest_type?n(v,e.a_info,e):c.openWxopen(e.a_info);
})):h[s+"_2"]||(h[s+"_2"]=!0,H.click_pos=2,u(H,function(){
i(88+W,e),h[s+"_2"]=!1,!!M&&M(),6!=e.a_info.dest_type?n(v,e.a_info,e):c.openWxopen(e.a_info);
}));
}
return!1;
}),r.on(j,"click",function(){
return h[s+"_3"]||(h[s+"_3"]=!0,H.click_pos=3,u(H,function(){
i(89+W,e),h[s+"_3"]=!1,!!M&&M(),6!=e.a_info.dest_type?n(v,e.a_info,e):c.openWxopen(e.a_info);
})),!1;
}),r.on(b,"click",function(){
return i(90+W,e),t(0,d,e.a_info.traceid,e.a_info.aid),"none"==window.getComputedStyle(x).display?(x.style.display="initial",
I.style.display="initial",parseInt(window.can_see_complaint)&&(z.style.display="initial")):(x.style.display="none",
z.style.display="none",I.style.display="none"),!1;
}),r.on(x,"click",function(){
i(91+W,e);
var t="https://mp.weixin.qq.com/promotion/res/htmledition/mobile/html/trade_about.html?aid="+y+"&tid="+s+"#wechat_redirect";
...
setTimeout(function(){
var e=f.clientWidth;
if(k)k.style.height=e/1.77+"px";else{
var i=T.offsetWidth,t=T.offsetWidth*parseInt(a.displayHeight)/parseInt(a.displayWidth);
O.setHeight(t),O.setWidth(i),f.style.width=i,f.style.height=t;
}
},0);
});
}
...
document.getElementById("js_sponsor_ad_area")),m=e("biz_wap/utils/ajax.js"),w=!1;
return a;
