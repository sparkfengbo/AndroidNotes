...
p[t]?p[t].push(o):(p[t]=[o],n["weapp_appid_"+o]=g.appidSnInfo[o].appid),a[i]?a[i].push(o):(a[i]=[o],
n["weapp_sn_"+o]=g.appidSnInfo[o].sn);
}
var f="/mp/appmsg_weapp?action=batch_get_weapp";
for(var c in n)f+="&"+c+"="+encodeURIComponent(n[c]);
d({
url:f,
type:"GET",
dataType:"json",
